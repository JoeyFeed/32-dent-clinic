...
-- ШАГ 1: Создание базы данных (выполните в консоли PostgreSQL или создайте через GUI)
...
-- ШАГ 2: Подключитесь к базе данных dent_clinic и выполните следующие команды:
